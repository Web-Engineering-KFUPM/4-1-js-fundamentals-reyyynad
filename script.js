...
const SCHOOL = "MyCollege";
// SCHOOL = "OtherCollege";  
// I got an Uncaught TypeError: Assignment to constant variable, we cannot re-assign const variables
...
// Read Chapter 4 in zyBooks: Conditional (ternary) operatore
...
console.log("testing var", a) // this work because var is function scoped
// console.log("testing let", b) // here i got an error and it is because let is block scoped
